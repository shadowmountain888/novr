...
public class CockpitHudTuningMenu : MonoBehaviour
{
    ...
    private void EnsureBuilt()
    {
        ...
        var rows = new List<Action<RectTransform>>
        {
            ...
            panel => AddSlider(panel, "WEAPON UP / DOWN (deg)", config.WeaponPanelVerticalAngle),
            panel => AddSlider(panel, "WEAPON SIZE", config.WeaponPanelSize),
            panel => AddSlider(panel, "MAP LEFT / RIGHT (deg)", config.MapPanelHorizontalAngle),
